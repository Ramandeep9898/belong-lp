...
export const Veterans = () => {
  ...
  return (
    <div className="flex w-full flex-col justify-center items-center bg-[#C9C2B8] pb-12 relative">
      ...
      <div className="p-7 z-10 flex flex-col justify-center items-center">
        ...
        <div className=" flex flex-wrap relative mb-14 !w-[285px] h-[350px] md:static md:!w-auto md:h-auto">
          <img src={sai.src} alt={"sai"} className="absolute w-[160px] md:w-[180px] top-0 left-0 md:static" />
          <img src={ankur.src} alt={"sai"} className="absolute top-0  w-[160px] md:w-[180px]  left-[120px] md:static" />
          <img src={ayush.src} alt={"sai"} className="absolute bottom-0  w-[160px]  md:w-[180px] rotate-[-5deg] md:rotate-0 left-0 md:static" />
          <img src={savitri.src} alt={"sai"} className="absolute bottom-[-20px] md:w-[180px]  w-[160px]  rotate-[-5deg] md:rotate-0 left-[120px] md:static" />
        </div>
